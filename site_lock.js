...
lk = {
  ...
  sharing: {
    ...
    url: 'http://forum.istorichka.ru/cgi-bin/yabb2/YaBB.pl#block',
    // Заголовок поста, который публикует пользователь в соцсетях
    title: 'Свободный Интернет под угрозой!',
     // Текст, который публикует пользователь в соцсетях (140 символов)
    text: '1 августа вступит в силу закон, который даёт возможность закрыть любой сайт в Интернете. Подробнее читайте здесь:',
